    ...
    return <><Header/>
        <main className="mx-auto w-full max-w-7xl flex-1 px-5 py-12 lg:px-8">
            <section
                ...
                <div><p className="mb-4 text-sm font-extrabold uppercase tracking-[0.25em] text-[#1a998d]">Walton
                    Plaza</p><h1
                    ...
                    trust.</p><a href="#products"
                                 className="mt-7 inline-flex rounded-xl bg-[#cd2027] px-5 py-3 text-sm font-bold text-white shadow-lg shadow-red-200 transition hover:bg-[#a1191f]">Explore
            ...
            <div id="products" className="mb-6 flex items-end justify-between">
                <div><p className="text-sm font-bold uppercase tracking-widest text-[#1a998d]">Shop collection</p><h2
